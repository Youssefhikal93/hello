...
const welcome = () => {
  return (
    <div className="flex flex-col gap-4 lg:gap-0">
      {/* Sponsor Banner */}
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 justify-items-center bg-neutral-900 py-8">
      ...
      <div className="flex flex-col items-center bg-neutral-800 p-16 space-y-4">
